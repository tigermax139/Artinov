function Display(sizeX, sizeY){
	...
	this.init = function(arg_X, arg_Y){
		...
		table.setAttribute('class','display_2');

		var conteiner = document.getElementById("content_2");
	...
	this.setPixel = function(x, y){
		...
		pixel.setAttribute("class", "active_2");
	}

	this.clearDisplay = function(){
		activCells = table.querySelectorAll(".active_2");
